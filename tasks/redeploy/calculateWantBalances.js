...
module.exports = (task) =>
  task(
    ...
    .addOptionalParam('result', "Define a path where validated CSV of want tokens balances and respective addresses would be stored.", './tasks/redeploy/csv/output/holdersLvAYI-ARB-result-want-tokens.csv', types.string)
    .addOptionalParam('csv', "Define a path where validated CSV of balances and addresses are stored.", './tasks/redeploy/csv/output/holdersLvAYI-ARB-result-vault-tokens.csv', types.string)
    .addOptionalParam('pps', "Define a PPS float value for conversion.", 0.992011, types.float)
