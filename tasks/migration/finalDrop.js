...
module.exports = (task) =>
  task(
    ...
    .addOptionalParam('csv', "Define a full path with name for CSV file.", './tasks/migration/csv/postMigration/finalMigration/lvDciV2HoldersFinallyMigrated.csv', types.string)
