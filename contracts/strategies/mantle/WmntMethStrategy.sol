...
//             address(MOE_MERCHANT_WMNT_METH_POOL)
//         );
...
//         result = _agniQuote(address(METH), address(want), methAmount) + _agniQuote(address(WMNT), address(want), wmntAmount);
//     }
...
//         _agniSwap(address(WMNT), address(want), removedLiquidityData.amountAWithdrawn);
//         _agniSwap(address(METH), address(want), removedLiquidityData.amountBWithdrawn);
...
//         _burnShares(balanceOfCircuitShares());
//         return want.balanceOf(address(this));
//     }
