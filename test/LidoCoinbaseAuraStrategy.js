...
describe("LidoCoinbaseAuraStrategy", function () {
    async function deployContractAndSetVariables() {
        ...
        const LidoCoinbaseAuraStrategy = await ethers.getContractFactory('LidoCoinbaseAuraStrategy');
        const strategy = await LidoCoinbaseAuraStrategy.deploy(vault.address);
    ...
    it('should migrate', async function () {
        ...
        const LidoCoinbaseAuraStrategy = await ethers.getContractFactory('LidoCoinbaseAuraStrategy');
        const newStrategy = await LidoCoinbaseAuraStrategy.deploy(vault.address);
